      ...
      <article class="mb-4">
        <div class="container px-4 px-lg-5">
          <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
              <p>
                "Safe vegetables" promote health and are free of chemical and
                microbiological hazards."Safe vegetable value chains" include
                input providers, farmers, collectors, food distribution and
                value-added processing facilities, and marketers who sell
              ...
              <p>
                As key actors in safe vegetable value chains, smallholder
                farmers are primed to increase their incomes and improve their
                food security.{" "}
              </p>
              <p>
